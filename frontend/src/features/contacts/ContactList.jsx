                    ...
                    <div className="flex flex-wrap gap-1 max-w-[180px]">
                      ...
                      {contact.tags &&
                        contact.tags.map((tag) => (
                          <span
                            key={tag}
                            className="inline-flex items-center text-[9px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-700 border border-gray-200 font-bold uppercase tracking-wider"
                          >
                            {tag}
                          </span>
                        ))}
                      {!contact.primary_interest && (!contact.tags || contact.tags.length === 0) && (
